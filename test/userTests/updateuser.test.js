...
test("Update User", async () => {
    ...
    body: JSON.stringify({ query: 
        `mutation{
            updateUser(id: "635639cb164bf6f078855fc1", name: "Bobby Shmurda", newuser: "Changed", email: "GoNewYorkGoNewYorkGo@gmail.com", newhash: "4567", newbio: "Mechanical Engineer"){
              name,
              username,
              email,
              hash,
